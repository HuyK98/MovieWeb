    ...
    <div className={`home-container ${darkMode ? "dark-mode" : ""}`}>
      <header>
        ...
        <nav>
          <ul>
            <li>
              <Link to="/showtimes">{translations[language].showtimes}</Link>
            </li>
            <li>
              <Link to="/movielist">{translations[language].movies}</Link>
            </li>
            <li>
              <Link to="/place">{translations[language].theaters}</Link>
            </li>
            <li>
              <Link to="/about">{translations[language].ticketPrices}</Link>
            </li>
            <li>
            ...
            {user ? (
              <>
                <li>
                  <span>
                    {translations[language].hello}, {user.name}
                  </span>
                </li>
                <li>
      ...
      <AnimatedSection animation="fade-up">
        <div className="featured-movies-section">
          <div className="section-header">
            <h2>{translations[language].featuredMovies}</h2>
            <div className="view-more">
              <Link to="/movielist">{translations[language].viewMore}</Link>
            </div>
          </div>
      ...
      <AnimatedSection animation="fade-left" delay={200}>
        <div className="movie-row-section">
          <div className="section-header">
            <h2>{translations[language].upcomingMovies}</h2>
            <div className="view-more">
              <Link to="/movielist">{translations[language].viewMore}</Link>
            </div>
          </div>
