...
const PriceList = () => {
  ...
  const [isScrolled, setIsScrolled] = useState(false); // Sửa setIsScrolled thành isScrolled
  ...
  return (
    <div className={`home-container ${darkMode ? "dark-mode" : ""}`}>
      <Header
        ...
        isScrolled={isScrolled} // Sửa thành isScrolled
      />
        ...
        <main className="price-main">
          <div className="price-banner">
            ...
            <div className="social-share">
              ...
              <button className="like-btn">{translations[language].likeBtn}</button>
              <button className="share-btn">{translations[language].shareBtn}</button>
            </div>
          </div>
          ...
          <div className="price-section">
            ...
            <div className="price-table">
              <div className="price-row header-row">
                <div className="price-cell">{translations[language].ticketType}</div>
                <div className="price-cell">10h - 18h</div>
                <div className="price-cell">18h - 22h</div>
              </div>
              <div className="price-row">
                <div className="price-cell">{translations[language].madSaleDays}</div>
                <div className="price-cell">40.000</div>
                <div className="price-cell">40.000</div>
              </div>
              <div className="price-row">
                <div className="price-cell">{translations[language].betaTen}</div>
                <div className="price-cell">45.000</div>
                <div className="price-cell">45.000</div>
              </div>
              <div className="price-row">
                <div className="price-cell">{translations[language].happyDay}</div>
                <div className="price-cell">{translations[language].daysOfWeek["Thứ 2, 4, 5, 6"]}</div>
                <div className="price-cell">60.000</div>
                <div className="price-cell">65.000</div>
              </div>
              <div className="price-row">
                <div className="price-cell">
                  {translations[language].daysOfWeek["Thứ 7"]}, {translations[language].daysOfWeek["CN"]}
                </div>
                <div className="price-cell">60.000</div>
                <div className="price-cell">65.000</div>
              </div>
              <div className="price-row">
                <div className="price-cell">{translations[language].publicHoliday}</div>
