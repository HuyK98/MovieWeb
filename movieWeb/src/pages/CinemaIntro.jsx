            ...
            <div className="right-section fade-in">
              <div className="contact-card">
                ...
                <div className="contact-item">
                  ...
                  />
                  <p>
                    <strong>Địa chỉ:</strong> {translations[language].address}
                  </p>
                </div>
                <div className="contact-item">
                  <FontAwesomeIcon icon={faPhone} className="contact-icon" />
                  <p>
                    <strong>Hotline:</strong> {translations[language].hotline}
                  </p>
                </div>
                <div className="contact-item">
                  <FontAwesomeIcon icon={faGift} className="contact-icon" />
                  <p>
                    <strong>{translations[language].specialServices}</strong>
                  </p>
                </div>
                <div className="contact-note">
                  <p>
                    <em>{translations[language].promotion}</em>
                  </p>
                </div>
