...
const PosterSection = ({ movies }) => {
    ...
    const handlePrev = () => {
        setThumbnailIndex((prevIndex) => (prevIndex === 0 ? movies.length - 1 : prevIndex - 1));
    };

    const handleNext = () => {
        setThumbnailIndex((prevIndex) => (prevIndex === movies.length - 1 ? 0 : prevIndex + 1));
    };

    return (
        <div className="poster-section">
            {/* Main Poster */}
            <img src={selectedMovie.imageUrl} alt={selectedMovie.title} className="poster-background" />
            <div className="main-poster">
                ...
                <div className="poster-details">
                    ...
                    <p className="poster-release-date">
                        Ngày phát hành: {new Date(selectedMovie.releaseDate).toLocaleDateString("vi-VN")}
                    </p>
                </div>
            ...
            <div className="thumbnail-section">
                ...
                {movies
                    ...
                    .map((movie) => (
                        <div
                            key={movie._id}
                            className={`thumbnail ${selectedMovie._id === movie._id ? "active" : ""}`}
